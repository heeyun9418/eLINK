		...
		<div class="container pt-3">
			<form action="modify.do" method="post" name="modifyForm">
				<input type="hidden" name="page_num" id="page_num"
					value="<%=article.getPage_num()%>" /> <input type="hidden"
					name="page" value="<%=request.getParameter("page_num")%>" />
				<table class="table table-striped table-bordered text-center">
					<thead class="thead-light">
						<tr>
							<th colspan="3">등록내역 수정</th>
						</tr>
					</thead>
					<tbody>
						<tr>
						...
						<tr>
							...
							<td><textarea class="form-control" placeholder="글 내용"
									...
									style="height: 350px; resize: none;"> <%=article.getContent()%></textarea></td>
						</tr>
					</tbody>
				</table>
				<section>
					<a href="javascript:modifybbs()"
