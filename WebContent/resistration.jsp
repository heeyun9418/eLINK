<%@page
	import="dao.PageDAO, vo.PageInfo, vo.Bbs, java.util.ArrayList, java.util.Vector, dao.BbsDAO, java.text.SimpleDateFormat"%>
...
<body oncontextmenu='return false' onselectstart='return false'
	...
	<div id="wrap">
		<section>
			<ul id="snb">
				<li id="cp2"><a href="resist.do">RESISTRATION</a></li>
		...
		<div id="list">
			<div class="container pt-3">
				...
				<table class="table table-striped border-bottom text-center">
					...
					<tr>
						<td><%=articleList.get(i).getPage_num()%></td>
						<td><a
						...
						<td><%=articleList.get(i).getAvailable()%></td>
					</tr>
					<%
						}
					}
				...
				<%
					if (id == null) {
				%>
				<a href="login.do" class="btn btn-primary float-right" id="writeBtn"
					onclick="return confirm('로그인 후 이용가능합니다')">글쓰기</a>
				<%
					} else {
				%>
