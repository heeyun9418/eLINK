...
<body>
	<div id="wrap">
		...
		<!-- JUMBOTRON -->
		<div id="list">
			<div id="checkForm" class="container pt-3">
				<form name="checkForm" action="checkPro.do" method="post">
					<table class="table table-bordered text-center">
						<tr>
							<th>비밀번호 확인</th>
							<td><input type="password" id="pw" class="form-control"
								name="pw" placeholder="비밀번호를 입력하세요" required="required"></td>
						</tr>
					</table>
					<button type="submit" class="btn btn-warning float-right"
						id="modifyBtn">확인</button>
					<br> <br>
				</form>
			</div>
		</div>
